...
public class SpeechRecognizingActivity
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FreeHand.SpeechRecognizingActivity, FreeHand, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", SpeechRecognizingActivity.class, __md_methods);
	}


	public SpeechRecognizingActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SpeechRecognizingActivity.class)
			mono.android.TypeManager.Activate ("FreeHand.SpeechRecognizingActivity, FreeHand, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
