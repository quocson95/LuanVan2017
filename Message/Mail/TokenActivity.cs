...
namespace FreeHand.Message.Mail
{
    ...
    public class TokenActivity : Activity
    {
        ...
        private void RefreshUi()
        {
            ...
            {
                refreshTokenInfoView.Text = (authState.RefreshToken == null ? "no_refresh_token_returned" :"refresh_token_returned");
                idTokenInfoView.Text = (authState.IdToken == null ? "no_id_token_returned" : ".id_token_returned");
